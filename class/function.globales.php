 ...
 ***********************************************************************************/
function checkPasswordTieneSimbolo(string $password): bool {
...
function validarCambioPassword(string $password1, string $password2): bool {
    ...
    if (checkPasswordTieneMinuscula($password1) && checkPasswordTieneMayuscula($password2) && checkPasswordTieneNumero($password1)
 ...
 * Sanitizar entrada
 ***********************************************************************************/
function sanitizarString(string | null $dato): string {
    if (is_null($dato)) {
        return "";
    }
    $dato = trim($dato);
...
// Pasar el mes a español
function getMesSpanish(int $mes): string
{
