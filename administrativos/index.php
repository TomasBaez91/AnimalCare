...
<head>
    ...
    <title><?php echo CONFIG_GENERAL['TITULO_WEB']; ?> - Administrativo</title>
    ...
    <!-- JS para la gestión de administrativo -->
    <script src="js/funciones.administrativos.js"></script>
    <style>
...
<body>
<?php include_once(__DIR__ . '/modal/crear.editar.administrativo.php'); ?>
        ...
        <div class="col-12">
            <div class="row">
                <div class="col-12 text-center">
                    <button class="btn btn-primary btn-lg shadow-lg" onclick="abrirModalAdministrativo(this, 0)"> <i class="bi bi-plus-circle">  </i>Añadir Administrativo</button>
                </div>
            </div>
            <!-- Tabla listado administrativo -->
            <div class="row">
                <div class="col-12">
                    <table class="table-striped tablaListado" id="tablaListadoAdministrativos" data-toggle="table"
                           data-url="<?php echo CONFIG_GENERAL['RUTA_URL_BASE']."/administrativos/GetJSONTablaAdministrativos.php"; ?>"
                           data-unique-id="id"
                           data-search="true"
