...
<body>
<?php include_once(__DIR__ . '/modal/crear.editar.auxiliar.php'); ?>
        ...
        <div class="col-12">
            <div class="row">
                <div class="col-12 text-center">
                    <button class="btn btn-primary btn-lg shadow-lg" onclick="abrirModalAuxiliar(this, 0)"> <i class="bi bi-plus-circle">  </i>Añadir Auxiliar</button>
                </div>
            </div>
            <!-- Tabla listado Auxiliar -->
            <div class="row">
                <div class="col-12">
                    <table class="table-striped tablaListado" id="tablaListadoAuxiliares" data-toggle="table"
                           data-url="<?php echo CONFIG_GENERAL['RUTA_URL_BASE']."/auxiliares/GetJSONTablaAuxiliares.php"; ?>"
                           data-unique-id="id"
                           data-search="true"
